...
**Total patched lines on upstream files: 18.** Budget: <500 (per `wezterm-fork/spec.md` requirement "All milliways-specific code lives in `milliways/` subtree"). Headroom: 482.
